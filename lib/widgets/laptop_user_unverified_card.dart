...
class laptop_user_unverified_card extends StatefulWidget {
  final Function(String laptopId)? onDelete;
  final Function(String laptopId)? onVerified;
  ...
  const laptop_user_unverified_card({
  ...
  @override
  State<laptop_user_unverified_card> createState() =>
      _laptop_user_unverified_cardState();
}

class _laptop_user_unverified_cardState
    extends State<laptop_user_unverified_card> {
  @override
      ...
      child: InkWell(
        ...
        onTap: () {
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      DetailLaptopUnverified(laptopId: widget.laptopId)));
        },
        child: Card(
                                      ...
                                      style: ButtonStyle(
                                          ...
                                          surfaceTintColor:
                                              MaterialStatePropertyAll(
                                                  Colors.white)),
                                      onPressed: () {
                                        widget.onVerified!(widget.laptopId);
                                      },
                                      child: Text(
                                        "Verifikasi",
                                        style: TextStyle(
